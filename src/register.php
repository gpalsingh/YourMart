...
Name: <input type="text" placeholder="First Name" id="person-name-first" onChange="checkFirstName();">
<input type="text" placeholder="Last Name" id="person-name-last" onChange="checkLastName();">
<br>
<span id="person-name-first-errors" class="hidden"><br></span>
<span id="person-name-last-errors" class="hidden"><br></span>
Email: <input type="text" placeholder="Email" id="person-email" onChange="checkEmailValid();"><br>
...
Username: <input type="new-username" placeholder="Username" id="person-username" onChange="checkUsernameValid();"><br>
<span id="person-username-errors" class="hidden"><br></span>
Password: <input type="password" placeholder="Your password" id="person-password" onChange="checkPasswordValid();"><br>
